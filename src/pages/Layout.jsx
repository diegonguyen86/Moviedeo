...
export default function Layout() {
  ...
  if (!user) {
    return (
      // 👇 FIX LỖI MOBILE: Thêm relative z-[100] để đè qua Header tàng hình
      <div className="relative z-[100] h-screen bg-black flex flex-col items-center justify-center text-white px-6">
        <div className="max-w-md text-center space-y-8">
          ...
          <button 
            ...
            className="w-full bg-primary hover:bg-primary-fixed text-white py-4 rounded-2xl font-black transition-all shadow-[0_10px_40px_rgba(var(--primary-rgb),0.3)] active:scale-95 relative z-50 pointer-events-auto"
          >
  ...
  // 2. NẾU ĐÃ ĐĂNG NHẬP NHƯNG CHƯA ĐƯỢC DUYỆT: Hiện màn hình chờ
  if (user && !isApproved) {
    return (
      // 👇 FIX LỖI MOBILE: Thêm relative z-[100]
      <div className="relative z-[100] h-screen bg-black flex flex-col items-center justify-center text-white px-6">
        <div className="max-w-xl text-center space-y-6">
          ...
          <div className="flex flex-col gap-4 mt-8">
            <button 
              ...
              className="bg-white/10 hover:bg-white/20 text-white px-8 py-3 rounded-xl font-bold transition-all uppercase text-sm border border-white/5 relative z-50 pointer-events-auto"
            >
            ...
            <button 
              onClick={logout}
              className="text-zinc-500 hover:text-red-500 text-xs font-bold uppercase tracking-widest transition-all relative z-50 pointer-events-auto"
            >
